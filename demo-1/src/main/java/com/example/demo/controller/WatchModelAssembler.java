 ...
 * 
 * import org.springframework.hateoas.EntityModel; import
 * org.springframework.hateoas.server.RepresentationModelAssembler; import
 * org.springframework.stereotype.Component;
 * 
 * import com.example.demo.pojo.Watch;
 * 
 * @Component class WatchModelAssembler implements
 * RepresentationModelAssembler<Watch, EntityModel<Watch>> {
 * 
 * @Override public EntityModel<Watch> toModel(Watch watch) {
 * 
